/**
 * MCPFusionTester Integration Tests
 *
...
import type { MiddlewareFn, ToolResponse } from '@mcpfusion/core';
import { MCPFusionTester, createMCPFusionTester } from '../src/index.js';
...
describe('MCPFusionTester', () => {
    ...
    describe('Construction', () => {
        it('should create via factory function', () => {
            const t = createMCPFusionTester(registry, { contextFactory: createMockContext });
            expect(t).toBeInstanceOf(MCPFusionTester);
        });

        it('should create via class constructor', () => {
            const t = new MCPFusionTester(registry, { contextFactory: createMockContext });
            expect(t).toBeInstanceOf(MCPFusionTester);
        });
    });
    ...
    describe('Context Overrides', () => {
        ...
        it('should not mutate the original context', async () => {
            ...
            const customTester = createMCPFusionTester(registry, {
                contextFactory: () => ctx1,
            });
    ...
    describe('Async Context Factory', () => {
        it('should support async contextFactory', async () => {
            const asyncTester = createMCPFusionTester(registry, {
