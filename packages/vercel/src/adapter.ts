 ...
 *
 * @typeParam TContext - Application context type for MCP Fusion handlers
 */
export interface VercelAdapterOptions<TContext> {
    ...
    /** MCP server name (visible in capabilities). Default: `'mcpfusion-vercel'` */
