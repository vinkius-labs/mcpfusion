...
/**
 * Transport interface for the MCP Fusion client.
 * This abstracts the MCP transport layer (stdio, HTTP, WebSocket, etc.)
 */
export interface MCPFusionTransport {
...
/**
 * Options for creating a MCPFusionClient.
 */
export interface MCPFusionClientOptions {
    /**
    ...
    /**
     * When `true`, `execute()` throws a {@link MCPFusionClientError}
 ...
 */
export interface MCPFusionClient<TRouter extends RouterMap> {
    /**
 ...
 * ```
 */
export function createMCPFusionClient<TRouter extends RouterMap>(
    transport: MCPFusionTransport,
    options?: MCPFusionClientOptions,
): MCPFusionClient<TRouter> {
