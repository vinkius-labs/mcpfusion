...
// ─── Re-exports (backward compat — tests import from mcpfusion.js) ──

export { parseArgs } from './args.js';
export type { CliArgs } from './args.js';
export { MCPFUSION_VERSION, HELP, ansi } from './constants.js';
...
async function main(): Promise<void> {
    ...
    switch (args.command) {
        ...
        case 'dbg': {
            ...
            try {
                const { runInspector } = await import('@mcpfusion/inspector');
