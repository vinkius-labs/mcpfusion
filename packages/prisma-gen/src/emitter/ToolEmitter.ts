 ...
 * 2. `CreateSchema` — input params (no @id/@default, no @mcpfusion.tenantKey, YES @mcpfusion.hide)
 ...
 * - @mcpfusion.tenantKey → injected into WHERE/data of every query from ctx
 ...
 * Excludes: @id with @default, @mcpfusion.tenantKey, auto-generated timestamps.
 */
function isAutoGenerated(field: DMMFField, annotations: ModelAnnotations): boolean {
    ...
    // @mcpfusion.tenantKey — injected from ctx, not from LLM
 ...
 * @param annotations - Parsed @mcpfusion.* annotations
...
export function emitTool(model: DMMFModel, annotations: ModelAnnotations): GeneratedFile {
    ...
    // ── Header ───────────────────────────────────────────
    lines.push(`/**`);
    lines.push(` * ${name}Tools — Generated by @mcpfusion/prisma-gen`);
    lines.push(` *`);
    ...
    lines.push(`import { defineTool } from '@mcpfusion/core';`);
    ...
    // Fields for CreateSchema: exclude auto-generated, include @mcpfusion.hide
