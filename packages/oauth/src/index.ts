/**
 * @mcpfusion/oauth — OAuth 2.0 Device Authorization Grant for MCP Servers
 *
 ...
 * @example
 * ```ts
 * import { DeviceAuthenticator, TokenManager, requireAuth } from '@mcpfusion/oauth';
 *
 * // Standalone usage
