...
Peer dependencies: `@mcpfusion/core` and `zod`.
...
```typescript
import { isSwagger2, convertSwagger2ToV3, parseOpenAPI } from '@mcpfusion/openapi-gen';
...
| Type-safe tRPC-style client for MCP tools | [MCPFusionClient](/fusion-client) |
