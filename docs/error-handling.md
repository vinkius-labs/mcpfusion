...
<span style="font-size:9px;color:rgba(52,211,153,0.7);letter-spacing:2px;font-weight:700">MCP Fusion — THE AI SELF-HEALS</span>
<div style="margin-top:12px">
...
```typescript
import { initMCPFusion, error, success } from '@mcpfusion/core';
...
```typescript
import { required } from '@mcpfusion/core';
...
```typescript
import { succeed, fail, error, success, type Result } from '@mcpfusion/core';
