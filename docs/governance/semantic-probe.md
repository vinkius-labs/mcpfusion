...
```typescript
import { createProbe } from '@mcpfusion/core/introspection';
...
```typescript
import type { SemanticProbeAdapter } from '@mcpfusion/core/introspection';
...
```typescript
import { evaluateProbe } from '@mcpfusion/core/introspection';
...
```typescript
import { evaluateProbes } from '@mcpfusion/core/introspection';
...
```typescript
import { buildJudgePrompt } from '@mcpfusion/core/introspection';
...
```typescript
import { aggregateResults } from '@mcpfusion/core/introspection';
...
Semantic probing integrates with `MCPFusionTester.callAction()` for automated regression testing:

```typescript
import { createTestClient } from '@mcpfusion/core/testing';
import { createProbe, evaluateProbe } from '@mcpfusion/core/introspection';
