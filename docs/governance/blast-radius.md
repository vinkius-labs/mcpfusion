...
```typescript
import { scanSource, buildEntitlements } from '@mcpfusion/core/introspection';
...
```typescript
import { validateClaims } from '@mcpfusion/core/introspection';
...
```typescript
import { scanAndValidate } from '@mcpfusion/core/introspection';
...
```typescript
import { scanEvasionIndicators } from '@mcpfusion/core/introspection';
