...
<div style="font-size:16px;color:rgba(255,255,255,0.7);margin-top:12px;line-height:1.6;font-style:italic;font-family:Inter,sans-serif">"Add OAuth device flow authentication to my MCP server using @mcpfusion/oauth — with automatic token refresh, persistent storage, and an auth tool for the AI agent."</div>
<!-- Action Bar -->
...
```typescript
import { DeviceAuthenticator, TokenManager } from '@mcpfusion/oauth';
