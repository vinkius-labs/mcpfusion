 ...
 *   2. initMCPFusion() — context initialization
 ...
 *   src/MCP Fusion       ← initMCPFusion<AppContext>() — single export
...
// ═══════════════════════════════════════════════════════════════
// FILE: src/MCP Fusion — Context Initialization (shared singleton)
// ═══════════════════════════════════════════════════════════════
